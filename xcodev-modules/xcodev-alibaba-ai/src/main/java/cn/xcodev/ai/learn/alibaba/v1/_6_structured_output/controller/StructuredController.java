package cn.xcodev.ai.learn.alibaba.v1._6_structured_output.controller;

import cn.xcodev.ai.learn.alibaba.v1._6_structured_output.records.Student;
...
public class StructuredController {
    ...
    public Student deepseek(@RequestParam(value = "sname", defaultValue = "xcodev") String sname,
                            @RequestParam(value = "email", defaultValue = "xcodev@xcodev.cn") String email) {
