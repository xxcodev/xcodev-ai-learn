package cn.xcodev.ai.learn.alibaba.v1._3_stream_output.config;
...
public class MultipleModelConfig {
    ...
    public ChatModel deepseek() {
        ...
        return DashScopeChatModel.builder()
                ...
                .defaultOptions(DashScopeChatOptions.builder().model(deepseek).build())
                .build();
    }
    ...
    public ChatModel qwen() {
        ...
        return DashScopeChatModel.builder()
                .dashScopeApi(DashScopeApi.builder().apiKey(apiKey).build())
                .defaultOptions(DashScopeChatOptions.builder().model(qwen).build())
                .build();
    }
